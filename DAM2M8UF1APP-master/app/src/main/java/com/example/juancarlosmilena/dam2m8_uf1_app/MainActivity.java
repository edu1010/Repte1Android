...
public class MainActivity extends AppCompatActivity implements PreguntasFragment.PreguntasFragmentListener, DialogFiPartida.DialogFiPartidaListener, PregMultiFragment.PregMultListener, ClasificacionFragment.classificacionLis {




    List<Pregunta> lista_preguntas = new ArrayList<>();
    List<Partida> lista_partidas = new ArrayList<>();
    @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            ...
            case R.id.juego2 :
                // juego 2
            case R.id.recyclerViewTool:
                Fragment fragment = new ClasificacionFragment();
