...
public class preguntasFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vistaFragment = inflater.inflate(R.layout.activity_main, container,false);


        Verdadero = vistaFragment.findViewById(R.id.Verdadero);
        Falso = vistaFragment.findViewById(R.id.Falso);
        Respuesta = vistaFragment.findViewById(R.id.Respuesta);

        MainActivity mainAcrivity = (MainActivity) getActivity();
